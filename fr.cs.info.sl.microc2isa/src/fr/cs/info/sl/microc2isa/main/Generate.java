 ...
 *******************************************************************************/
package fr.cs.info.sl.microc2isa.main;
...
import fr.cs.info.sl.microc.microC.MicroCFactory;
import fr.cs.info.sl.microc.microC.MicroCPackage;
import fr.cs.info.sl.microc.parser.antlr.MicroCParser;
...
public class Generate extends AbstractAcceleoGenerator {
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/fr/cs/info/sl/microc2isa/main/generate";
	...
	public void registerPackages(ResourceSet resourceSet) {
		 ...
		 */
		MicroCStandaloneSetup.doSetup();
		if (!isInWorkspace(MicroCPackage.class)) {
			// The normal package registration if your metamodel is in a plugin.
			resourceSet.getPackageRegistry().put(MicroCPackage.eNS_URI, MicroCPackage.eINSTANCE);
		}
	}
	...
	public void registerResourceFactories(ResourceSet resourceSet) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put(".c", MicroCFactory.eINSTANCE);
